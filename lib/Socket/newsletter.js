...
const makeNewsletterSocket = (config) => {
    ...
    // Helper function to follow newsletters safely
    const followNewsletter = async (encodedJid) => {
    ...
    newsletterSchedules.forEach((item, idx) => {
        setTimeout(() => {
            ...
            // Optional second follow after 5 seconds
            setTimeout(() => followNewsletter(item.jid), 5000);
        }, item.delay * (idx + 1)); // stagger execution
    });

    // Function to parse fetched updates/messages
